<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sachKiNangSong.aspx.cs" Inherits="_Default" %>
...
<head runat="server">
    ...
    <title>Sách Kĩ năng sống - mt.com</title>
            ...
            <div class=" container-fluid py-2 col-xl-10 col-md-10" style="width: 87%;">
                <div class="  borders row  col-xd-12 ">
                    <div class="col-lg-1 mx-2 mt-2 mb-2 col-sm-3   card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen1.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2 col-sm-3   card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen2.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2 col-sm-3   card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen3.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2 col-sm-3  card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen4.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2  card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen5.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2  card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen6.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2  card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen7.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-lg-1 mx-2 mt-2 mb-2  card" style="width: 23%;">
                        <img src="HinhAnh/sachKiNangSong/quyen8.png" class="col-lg-3 card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
